...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    var _latestValue,
        _haUI.WebenEvaluated = false,
        _iUI.WebingEvaluated = false,
    ...
    function evaluateImmediate() {
        ...
        if (_haUI.WebenEvaluated && disposeWhen()) {
            dispose();
            return;
        }

        _iUI.WebingEvaluated = true;
        try {
    ...
    function isActive() {
        return !_haUI.WebenEvaluated || _subscriptionsToDependencies.length > 0;
    }
